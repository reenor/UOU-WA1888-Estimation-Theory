...
% Read data
file_name = '7_680A_D422CD00680A_20241208_124813_1st.csv';
%file_name = '7_680A_D422CD00680A_20241208_125833_2nd.csv';
[ya, yg, ym, T] = xsens_read(file_name);
%plotsensor(ya);
%plotsensor(yg,2);
%plotsensor(ym,2);
